        ...
        do {
            ...
            switch (opcion) {
                ...
                case "1":
                    ...
                    Personas persona = new Personas(codigo, nombre, email,
                            new HashSet());
                ...
                case "2":
                    ...
                    break;
                case "3":
                    System.out.println("Introduce código curso: ");
                    short relCodCurso = teclado.nextShort();
                    teclado.nextLine();

                    System.out.println("Introduce código persona: ");
                    short relCodPersona = teclado.nextShort();
                    teclado.nextLine();
                    ...
                    Cursos cursoRel = (Cursos) resultados.get(0);
                    Personas personaRel = (Personas) resultados2.get(0);
                    cursoRel.getPersonases().add(personaRel);
                    //personaRel.getCursoses().add(cursoRel);

                    sesion.update(cursoRel);
                    //sesion.update(personaRel);
